...
var Pagination = function (_React$Component) {
  ...
  function Pagination(props) {
    ...
    var locale = I18n._localKey || _this.props.locale || DEFAULT_LOCALE;
    locale = locale.toLowerCase();
    var supportedLocales = file.readdirSync(LOCALE_PATH);
    ...
    try {
      for (var _iterator = supportedLocales[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var sl = _step.value;
    ...
    _this._localeObj = require(LOCALE_PATH + '/' + locale);
