...
var Pagination = function (_React$Component) {
  ...
  Pagination.prototype._fallbackUrl = function _fallbackUrl(p) {
    if (p === 'next') {
      if (this._hasNext()) {
  ...
  Pagination.prototype.render = function render() {
    ...
    if (allPages <= 9) {
      ...
      for (var _i = left; _i <= right; _i++) {
        ...
        pagerList.push(React.createElement(Pager, {
          ...
          page: _i,
          active: _active,
          fallbackUrl: this._fallbackUrl(_i)
        }));
      }
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement('a', { onClick: function onClick(evt) {
            evt.preventDefault();
          }, href: this._fallbackUrl('prev') })
      ),
      pagerList,
      React.createElement(
        'li',
